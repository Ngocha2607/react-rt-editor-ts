...
export const ToolbarRow = React.forwardRef<HTMLDivElement, BaseProps>(
  ({ children, className, ...props }, ref) => {
    const rowRef = React.useRef<HTMLDivElement>(null);
    const isVisible = useRowVisibility(rowRef);
    ...
    return (
      <div
        ...
        role="row"
        className={clsx(`tiptap-toolbar-row`, className)}
        {...props}
      >
        {children}
      </div>
